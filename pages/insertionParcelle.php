...
.bouton-vert {
  ...
  <h5 class="card-title fw-semibold mb-4" style="text-align:center;">Gestion de Parcelle</h5>
        <div class="card">
          <div class="card-body">
          <form action="traitement_parcelles.php" method="post">
            
          <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Numero Parcelle</label>
            ...
            <select name="the" class="select-personnalise" id="produitsContainer" name="idThe">

                </select>
            </div>
            <button id="submitt" type="submit" class="btn btn-primary" style = "background-color: #5cb874">Inserer</button>
            </form>
        </div>
       </div> 
       ...
       <div class="card">
          ...
          <form action="">
          <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Parcelle</label>
              <input type="number" class="form-control" id="parcelle" name ="parcelle">
            </div>
            <button id="submit" type="submit" class="btn btn-primary" style = "background-color: #5cb874">Afficher tableau</button>
          </form>
          </div>
       </div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table table-responsive-xl" name = "table" id="tableProduits">
						  <thead>
						    <tr>
						    	<th>Numero</th>
						      <th>Surface</th>
						      <th>Th&eacute Plant&eacute</th>
						      <!-- <th>&nbsp;</th>	
						      <th>&nbsp;</th>	 -->
						    </tr>
						  </thead>
  ...
  <script src="sa_parcelle.js">
    <script src="sa_listeParcelle.js">
