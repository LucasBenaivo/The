...
.bouton-vert {
  ...
  <body>
    <?php
        include ("header.html"); ?>
        <br><br>
  <h5 class="card-title fw-semibold mb-4" style="text-align:center;">Insertion Prix  de vente</h5>
  <div class="card">
          <div class="card-body">
       <form action ="../TheFinal/PrixVente.php" method ="POST">
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Liste Th&eacute plant&eacute</label>
            <select name="the" class="select-personnalise" id="selectThe">
                
                </select>
            </div>
            
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Prix du th&eacute;</label>
              <input type="number" class="form-control" id="dtn" aria-describedby="emailHelp" name="prixThe">
            </div>
            <button id="showbut" type="submit" class="btn btn-primary" style = "background-color: #5cb874">Valider</button>
            </form>
