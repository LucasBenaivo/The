  ...
  <body>
    <?php
        ...
        <div class="container1">
            <button class="bouton-vert"><a href="insertionThe.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Insertion Th&eacute</a></button>
            <button class="bouton-vert"><a href="updateThe.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Update Th&eacute</a></button>
        </div>
        <br>
        <div class="container1">
        ...
        <br>
        <div class="container1">
            <button class="bouton-vert"><a href="gestionCueilleur.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Gestion Cueilleur</a></button>
        </div>
        <br>
        <div class="container1">
        ...
        <br>
        <div class="container1">
            <button class="bouton-vert"><a href="newPoids.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Nouveau Poids</a></button>
        </div>

        <!-- <br>
        <br>
        <div class="container1">
            <button class="bouton"><a href="index.html" class="btn-get-started animate__animated animate__fadeInUp scrollto">Deconnection</a></button>
        </div> -->
        <!-- <br>
