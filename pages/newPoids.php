        ...
        <div class="card">
          ...
          <form action ="" method ="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="bonus">
            </div>

            
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Mallus</label>
              <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="mallus">
            </div>
