        ...
        <div class="card">
          ...
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="occupationParM2" name ="occupation">
            </div>
            <div class="mb-3">
            ...
            <button id="submitt" type="submit" class="btn btn-primary" style = "background-color: #5cb874" onclick="submitForm()">Inserer</button>
        </div>
       </div>      
