...
.bouton-vert {
  ...
  <body>
    <?php
        include ("header.html"); ?>
        <br>
  <h5 class="card-title fw-semibold mb-4" style="text-align:center;">Gestion de th&eacute</h5>
        <div class="card">
          <div class="card-body">
          <form>
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Liste Th&eacute</label>
            ...
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Rendement par pied</label>
              <input type="number" class="form-control" id="rendement" name ="rendement">
            </div>
            
            </form>
            <button id="submitt" type="submit" class="btn btn-primary" style = "background-color: #5cb874" onclick="submitUpdateForm()">Update</button>
        </div>
       </div>     
