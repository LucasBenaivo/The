...
.bouton-vert {
        ...
        <div class="card">
          ...
          <form action ="" method ="POST">
            <div class="mb-3">
              ...
              <input id="salaire" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="salaire">
            </div>
  ...
  <script src="configCategorieDepense.js"></script>
  </html>