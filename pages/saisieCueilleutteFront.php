...
.bouton-vert {
  ...
  <h5 class="card-title fw-semibold mb-4" style="text-align:center;">Cueillette</h5>
        <div class="card">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Cueilleur</label>
                <select name="cueilleur" class ="select2"  id="selectCueil">
            ...
            <div class="mb-3">
                ...
                <select name="parcelle" class ="select2" id="selectParc">
            ...
            <div class="mb-3">
              ...
              <label for="exampleInputEmail1" class="form-label">Nombre de Poids Cueillis</label>
              <input type="number" class="form-control" id="poids" aria-describedby="emailHelp" name="nbrPoidsCueillis">
            </div>
  ...
  <script src="saisie_cueillette.js"></script>
  </html>