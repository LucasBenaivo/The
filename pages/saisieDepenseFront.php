...
.bouton-vert {
  ...
  <body>
    <?php
        include ("header.html"); ?>
  <h5 class="card-title fw-semibold mb-4" style="text-align:center;">Saisie Depense</h5>
        <div class="card">
          <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Categorie depense</label>
                <select name="categorieDepense" class ="select2" id="selectCat">
